...
class CollectionViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func setUI() {
        ...
        collectionView!.register(UICollectionViewCell.self, forCellWithReuseIdentifier: CollectionViewController.cellId)
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        // 定义一个cell
        let cell:UICollectionViewCell = collectionView.dequeueReusableCell(withReuseIdentifier: CollectionViewController.cellId, for: indexPath)
